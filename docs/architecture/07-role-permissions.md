...
| Symbol | Meaning |
| :----: | :--- |
| **I**  | Permission **xxx** (inherited / allowed) |
| **D**  | Permission xxx by **xxx** only |
...
|-------------------|-----------------|------------------------------------------------------------------------------------------------------------------------------|
| Admin             | xxx/COM        | xxx |
| Local Contributor | xxx            |xxx                               |
| EEAS User         | xx            | xxxx                                                  |
| Advanced User     | xxx            | xxx                                                |
| Policy Follower   | xx/COM        | xxx                                                           |
| External Expert   | xx             | xxx                                                             |
| Observer          | xx/xx | xxx                                                            |
